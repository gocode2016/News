...
<!-- Header ends -->
		...
		<div class="content">
			...
			<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-table"></i> 屏蔽词管理</h2>
					...
					<div class="bread-crumb pull-right">
						...
						<a href="${pageContext.request.contextPath}/adminComment_getAllComment.action?page=1" class="bread-current"><i class="icon-table"></i> 评论管理</a>
						<span class="divider">/</span>
						<a href="#" class="bread-current"><i class="icon-table"></i> 屏蔽词管理</a>
					</div>
						...
						<div class="row">
							<form class="form-horizontal" role="form">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-1 col-sm-offset-2 lab3">屏蔽词：</label>
									
									<div class="col-sm-5">
										<input type="text" class="form-control"  placeholder="屏蔽词">
									</div>
									<div class="col-sm-2">
										<button type="submit" class="btn btn-info">搜索</button>&nbsp;&nbsp;
										<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addDirty">添加屏蔽词</button>
									</div>
								</div>
							</form>
						</div>
						<!-- 添加到专题的弹出框 -->
			<div class="modal fade" id="addDirty" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
							<h4 class="modal-title">添加屏蔽字</h4>
						</div>
						<div class="modal-body">
							<form action="manage-dirtyadd.action">
								<div class="form-group row">
									<label class="col-lg-2 col-lg-offset-1 control-label lab3" >屏蔽词：</label>
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="屏蔽词" name="newsLabelName">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-lg-2 col-lg-offset-1 control-label lab3" >替换内容：</label>
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="替换内容" name="updateTo">
									</div>
								</div>
								<hr />
								...
								<div class="widget">
									...
									<div class="widget-content">
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<c:forEach items="${dirties }" var="dirty">
													<tr>
														<td>
														...
														<td>${dirty.content }</td>
														<td>${dirty.updateTo }*</td>
														<td>
															<a class="btn btn-xs btn-danger delete" href="manage-dirtydelete.action?newsLabelId=${dirty.dirtyId }"><i class="icon-remove"></i> </a>
														</td>
													</tr>
												</c:forEach>
