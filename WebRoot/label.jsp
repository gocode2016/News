...
<!-- Header ends -->
		...
		<div class="content">
			...
			<div class="sidebar">
				...
				<ul id="nav">
					...
					<li><a href="index.jsp"><i class="icon-home"></i> 首页</a>
			          ...
			          <li><a href="${pageContext.request.contextPath}/manage-label.action" class="open"><i class="icon-tag"></i> 标签管理</a>
				</ul>
			</div>
			<!-- Sidebar ends -->
			...
			<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-tag"></i> 标签管理</h2>
					...
					<div class="bread-crumb pull-right">
						...
						<a href="${pageContext.request.contextPath}/manage-label.action" class="bread-current"><i class="icon-tag"></i> 标签管理</a>
					</div>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="widget">
									...
									<div class="widget-content">
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<c:forEach items="${newsLabels }" var="label">
													<tr>
														<td>
															<input type="checkbox" id="inlineCheckbox1" name="item" value="option1">
														</td>
														<td>${label.newsLabelId }</td>
	
														<td>${label.newsLabelName }</td>
														
														<td>
															<a class="btn btn-xs btn-danger delete" href="${pageContext.request.contextPath}/manage-labeldelete.action?newsLabelId=${label.newsLabelId}"><i class="icon-remove"></i> </a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
										...
										<div class="widget-foot">
											<div style="margin-top: 10px; float: left;">
												...
												<button class="btn btn-xs btn-success " data-toggle="modal" data-target="#addLabel">添加标签</button>
											</div>
								...
								<!-- 添加标签的弹出框 -->
			<div class="modal fade" id="addLabel" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="${pageContext.request.contextPath}/manage-labeladd.action">
								<div class="form-group row">
									<label class="col-lg-2 col-lg-offset-1 control-label lab3" >标签：</label>
									<div class="col-lg-8">
										<input type="text" class="form-control" placeholder="标签名" name="newsLabelName">
									</div>
								</div>
								<hr />
